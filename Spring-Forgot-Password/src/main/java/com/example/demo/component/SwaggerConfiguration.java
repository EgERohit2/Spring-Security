...
public class SwaggerConfiguration {
	...
	private ApiInfo getInfo() {
		return new ApiInfo("Spring Swagger", "learning swagger", "1.0", "Terms of services",
				new Contact("Rohit", "https://localhost:8080", "rohitjadhv@nimpinfotech.com"), "License of apis",
